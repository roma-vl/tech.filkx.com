export default {
  ...
  meta: {
    ...
    catalogDescription: "Переглядайте повний каталог FilkxTech: смартфони, ноутбуки, аудіотехніка та розумні гаджети з офіційною гарантією і швидкою доставкою по Україні.",
    blogTitle: "Блог — FilkxTech",
    blogDescription: "Технологічні новини, огляди та поради з вибору техніки від команди FilkxTech.",
  },
  footer: {
  ...
  cart: {
    ...
    drawer: {
      ...
      freeShippingRemaining: "Додайте товарів ще на {amount} для БЕЗКОШТОВНОЇ доставки!",
