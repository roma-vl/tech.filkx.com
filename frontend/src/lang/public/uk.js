export default {
  auth: {
    ...
    register: {
      ...
      successMessage: "Реєстрація успішна! Будь ласка, перевірте пошту для підтвердження.",
      errorMessage: "Помилка реєстрації. Перевірте введені дані.",
    },
    forgotPassword: {
      title: "Відновлення пароля",
      subtitle: "Введіть адресу електронної пошти, і ми надішлемо посилання для відновлення пароля.",
      emailLabel: "Електронна пошта",
      emailPlaceholder: "name.company.com",
    ...
    verifyEmailNotice: {
      ...
      subtitle: "Будь ласка, підтвердіть адресу електронної пошти для доступу до всіх функцій.",
      instructions: "Ми надіслали посилання для підтвердження на вашу адресу. Будь ласка, натисніть на нього, щоб підтвердити акаунт.",
    ...
    verifyEmail: {
      ...
      verifyingSubtitle: "Будь ласка, зачекайте, поки ми підтвердимо вашу адресу.",
      successTitle: "Пошту підтверджено!",
      successSubtitle: "Дякуємо за підтвердження пошти. Тепер вам доступні всі функції сайту.",
