...
export const Mappers = {
  product(dto: any): Product {
    ...
    return {
      ...
      specs: camel.specs || {},
      rating: camel.approvedReviewsAvgRating != null ? parseFloat(camel.approvedReviewsAvgRating) : (Number(camel.rating) || 0),
      reviews: camel.approvedReviewsCount != null ? Number(camel.approvedReviewsCount) : (Number(camel.reviews) || 0),
