<template>
  <div
    class="rich-editor rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-800"
  >
    <!-- Toolbar -->
    <div
      class="flex flex-wrap items-center gap-0.5 px-3 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50"
    >
      <!-- Text formatting -->
      <ToolbarButton
...
const ListOrderedIcon = makeIcon([
  "M10 6h11",
  "M10 12h11",
  "M10 18h11",
  "M4 6h1v4",
...
.ProseMirror code {
  @apply bg-gray-100 dark:bg-gray-700 text-rose-500 dark:text-rose-400 rounded px-1.5 py-0.5 text-xs font-mono;
}
.ProseMirror pre code {
  @apply bg-transparent text-inherit;
}
.ProseMirror hr {
  @apply border-gray-200 dark:border-gray-600 my-5;
}
.ProseMirror img {
  @apply rounded-xl max-w-full my-4 mx-auto;
}
.ProseMirror a {
