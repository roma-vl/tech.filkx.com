  ...
  <div class="relative flex items-start gap-4 group">
    ...
    >
      ...
      >
        <div>
          <p
            class="font-black text-base text-gray-900 dark:text-white tracking-tight leading-tight uppercase"
          >
            {{ log.message }}
          </p>
      ...
      <div
        class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-50 dark:border-gray-700/50"
      >
        ...
        <div class="flex items-center gap-3">
          <div
            class="w-8 h-8 rounded-xl bg-gray-50 dark:bg-gray-900 flex items-center justify-center text-gray-400"
          >
          ...
          <div class="flex flex-col">
            ...
            <span
              class="text-xs font-bold text-gray-700 dark:text-gray-300 font-mono"
            >
              {{ log.ipAddress }}
            </span>
          </div>
      ...
      <div
        class="mt-4 p-3 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-800"
      >
        <div class="flex items-center gap-2">
          ...
          <span
            class="text-[11px] font-bold text-gray-600 dark:text-gray-400 font-mono"
          >
            {{ log.action }}
          </span>
        </div>
