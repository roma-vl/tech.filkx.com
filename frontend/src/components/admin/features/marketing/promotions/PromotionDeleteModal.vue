          ...
          >
            ...
            >
              <div class="px-6 py-6 text-center">
                ...
                >
                  {{
                    t("admin.marketing.promotions.alerts.delete_confirm_title")
                  }}
                </DialogTitle>
                ...
                <div class="mt-4">
                  <p class="text-sm font-bold text-gray-500 dark:text-gray-400">
                    {{
                      t("admin.marketing.promotions.alerts.delete_confirm", {
                        name: promotion?.name,
                      })
                    }}
                  </p>
                  ...
                  >
                    {{ t("admin.marketing.promotions.alerts.delete_warning") }}
                  </p>
                </div>
              </div>
              ...
              >
                <button
                  ...
                  :disabled="loading"
                  @click="$emit('confirm', promotion)"
                >
                  <span
                    v-if="loading"
                    class="loading loading-spinner loading-xs"
                  />
                  {{ t("admin.marketing.promotions.actions.delete") }}
                </button>
                <button
                  type="button"
