...
<template>
  ...
  >
    ...
    <div class="p-5">
      <h3
        class="font-extrabold text-[10px] uppercase tracking-widest text-zinc-450 dark:text-zinc-500 mb-3.5"
      >
        Категорія
      </h3>
      <div class="space-y-1">
        <a
          :class="
            !selectedCategory
              ...
              : 'text-zinc-550 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 font-semibold'
          "
    ...
    <div class="p-5 space-y-3">
      <h3
        class="font-extrabold text-[10px] uppercase tracking-widest text-zinc-450 dark:text-zinc-500 mb-1"
      >
        Фільтри швидкого вибору
      </h3>
      <label
    ...
    <div class="p-5">
      <h3
        class="font-extrabold text-[10px] uppercase tracking-widest text-zinc-450 dark:text-zinc-500 mb-4"
      >
        Ціновий діапазон
      </h3>
      <PriceRangeSlider
    ...
    <div class="p-5">
      <div class="flex items-center justify-between mb-3.5">
        ...
        <button
          class="text-[9px] text-[#00a046] font-black hover:underline uppercase tracking-wider"
          type="button"
          @click="localBrands = []"
        >
          Очистити
      ...
      <div class="space-y-1.5 max-h-48 overflow-y-auto custom-scrollbar pr-1">
        <label
          ...
          :key="brand.slug"
          class="flex items-center justify-between group cursor-pointer p-1 rounded hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
        >
    ...
    <div class="p-5">
      ...
      <div class="space-y-1">
        <label
          ...
          :key="rate"
          class="flex items-center gap-2 cursor-pointer p-1 rounded hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
        >
          <input
            v-model="localRating"
            type="radio"
