...
const addressesList = ref([
  ...
  },
  {
    ...
    type: "Офіс",
    recipient: "Роман Шевченко",
    street: "вул. Дегтярівська 10, оф. 104",
    city: "Київ",
    state: "Київська область",
    zip: "04050",
    country: "Україна",
...
const inputClass =
  "w-full bg-zinc-55 dark:bg-zinc-850 border border-zinc-200 dark:border-zinc-800 rounded-lg px-4 py-2.5 text-xs md:text-sm text-zinc-850 dark:text-zinc-150 focus:ring-1 focus:ring-[#00a046] focus:border-[#00a046] outline-none";
</script>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          >
            ...
            <div class="md:col-span-2 pt-2 text-right">
              <button
                type="submit"
                class="bg-[#00a046] hover:bg-[#00b050] text-white px-6 py-3 rounded-lg font-extrabold text-xs md:text-sm transition-all uppercase tracking-wider shadow-sm"
              >
                Зберегти профіль
              </button>
            </div>
      ...
      <div class="space-y-6">
        ...
        >
          ...
          >
            <h3 class="font-extrabold text-base text-zinc-900 dark:text-white">
              Книга адрес
            </h3>
            <button
              class="text-[#00a046] hover:text-[#00b050] text-xs md:text-sm font-extrabold hover:underline flex items-center gap-0.5"
          ...
          <div class="space-y-3">
            <div
              ...
              :key="address.id"
              class="border border-zinc-200 dark:border-zinc-800 rounded-lg p-4 text-xs md:text-sm hover:bg-zinc-50 dark:hover:bg-zinc-850/50 transition-colors"
            >
              ...
              <p class="text-zinc-550 dark:text-zinc-400 mt-1">
                {{ address.street }}
              </p>
              <p class="text-zinc-550 dark:text-zinc-400">
                м. {{ address.city }}, {{ address.state }} {{ address.zip }}
              </p>
              <div
                class="mt-4 flex gap-3 border-t border-zinc-100 dark:border-zinc-800 pt-3"
              >
                <button
                  class="text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors font-extrabold"
                  @click="openAddressModal(address)"
                >
                  Редагувати
                </button>
                <button
                  class="text-zinc-500 hover:text-rose-500 transition-colors font-extrabold"
                ...
                <button
                  v-if="!address.isDefault"
                  class="text-[#00a046] hover:underline ml-auto font-extrabold text-[10px] uppercase"
                  @click="setAddressDefault(address.id)"
                >
                  Встановити як основну
                </button>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div class="space-y-4">
            <div
              ...
              :class="
                card.isDefault
                  ? 'bg-gradient-to-tr from-emerald-955 via-[#00a046] to-emerald-800 border-[#00a046]/30'
            ...
            >
              ...
              <p class="font-mono text-base tracking-widest my-2">
                {{ card.number }}
              </p>
              ...
              <div
                class="absolute inset-0 bg-black/85 backdrop-blur-sm opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center gap-3"
              >
                <button
                  v-if="!card.isDefault"
    ...
    >
      ...
      >
        ...
        <div class="space-y-1.5">
          <label
            class="text-[10px] font-extrabold text-zinc-450 dark:text-zinc-500 uppercase tracking-wider"
          >Вулиця, будинок, квартира *</label><input
        ...
        >
          <button
            type="button"
            class="border border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 px-4 py-2.5 rounded-lg font-extrabold hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-all text-xs md:text-sm"
            @click="isAddressModalOpen = false"
          >
            Скасувати
          </button>
          <button
            type="submit"
            class="bg-[#00a046] hover:bg-[#00b050] text-white px-5 py-2.5 rounded-lg font-extrabold hover:bg-[#00b050] transition-all text-xs md:text-sm"
          >
            Зберегти
          </button>
        </div>
    ...
    >
      ...
      >
        ...
        <div class="space-y-1.5">
          <label
            class="text-[10px] font-extrabold text-zinc-450 dark:text-zinc-500 uppercase tracking-wider"
          >Ім'я власника картки *</label><input
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="space-y-1.5">
            <label
              class="text-[10px] font-extrabold text-zinc-450 dark:text-zinc-500 uppercase tracking-wider"
            >Термін дії *</label><input
              v-model="cardForm.expiry"
              type="text"
              placeholder="ММ/РР"
              required
              class="w-full bg-zinc-55 dark:bg-zinc-850 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2.5 text-zinc-800 dark:text-zinc-200 focus:ring-1 focus:ring-[#00a046] outline-none"
            >
          </div>
          <div class="space-y-1.5">
            <label
