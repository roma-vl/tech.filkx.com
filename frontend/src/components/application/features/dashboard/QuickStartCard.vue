<template>
  ...
  >
    ...
    <div
      ...
      :class="{
        ...
        'bg-red-50 text-red-600 border-red-200 dark:bg-red-500/20 dark:text-red-400 dark:border-red-500/30':
          action.color === 'red',
        'bg-purple-50 text-purple-600 border-purple-200 dark:bg-purple-500/20 dark:text-purple-400 dark:border-purple-500/30':
          action.color === 'purple',
      }"
    >
      <component
    ...
    <p
      class="text-gray-500 dark:text-gray-400 text-sm mb-6 flex-grow leading-relaxed font-medium"
    >
      {{ action.description }}
    </p>
