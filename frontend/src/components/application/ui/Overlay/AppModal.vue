...
const panelClass = computed(() => {
  return [
    "relative transform overflow-hidden bg-white dark:bg-gray-800",
          ...
          >
            ...
            >
              <div
                ...
                class="flex items-center justify-between px-4 py-4 sm:px-6 border-b border-gray-100 dark:border-gray-700"
              >
                <h3
              ...
              <div
                v-if="$slots.footer"
                class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end px-4 py-4 sm:px-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/30"
              >
                <slot name="footer" />
              </div>
            </div>
