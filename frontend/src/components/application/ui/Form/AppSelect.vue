  ...
  >
    ...
    <div class="relative">
      ...
      <button
        type="button"
        :disabled="disabled"
        class="relative w-full bg-white dark:bg-gray-800 border rounded-lg shadow-sm pr-10 py-2.5 text-left text-gray-900 dark:text-gray-200 cursor-default focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-all duration-200"
        :class="[
          disabled
