...
const slides = [
  ...
  },
  {
    ...
    description: 'Повністю пориньте в ігровий процес завдяки вигнутому екрану з радіусом кривизни 1500R та частотою оновлення 144 Гц.',
  ...
  },
  {
    ...
    description: 'Відстежуйте показники здоров\'я та тренування за допомогою точного GPS та до 7 днів роботи на одному заряді.',
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="flex flex-col gap-5 h-[380px] md:h-[480px] justify-between">
        ...
        <div class="relative flex-1 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-950 to-purple-900 border border-purple-500/20 shadow-md p-6 flex flex-col justify-between group hover:border-purple-500/40 transition-colors">
          <div class="absolute right-0 bottom-0 w-1/2 h-full opacity-30 group-hover:scale-110 transition-transform duration-700 pointer-events-none">
            <svg class="w-full h-full text-purple-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M2.25 21h19.5M3 10.5h.008v.008H3V10.5zm3 0h.008v.008H6V10.5zm3 0h.008v.008H9V10.5zm0-3h.008v.008H9V7.5zm3 3h.008v.008h-.008V10.5zm3 0h.008v.008H15V10.5zm3 0h.008v.008H18V10.5zm-3-3h.008v.008H15V7.5zm-6 6h.008v.008H9v-.008zm3 0h.008v.008h-.008v-.008zm3 0h.008v.008H15v-.008z" />
            </svg>
          </div>
        ...
        <div class="relative flex-1 rounded-2xl overflow-hidden bg-gradient-to-br from-emerald-950 to-teal-900 border border-emerald-500/20 shadow-md p-6 flex flex-col justify-between group hover:border-emerald-500/40 transition-colors">
          <div class="absolute right-0 bottom-0 w-1/2 h-full opacity-35 group-hover:scale-110 transition-transform duration-700 pointer-events-none">
            <svg class="w-full h-full text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 2.25V4.5m0 15v2.25m-9.75-9.75h2.25m15 0h2.25M6.22 6.22l1.59 1.59m10.38 10.38l1.59 1.59M6.22 17.78l1.59-1.59m10.38-10.38l1.59-1.59" />
            </svg>
          </div>
          <div class="relative z-10">
