  ...
  const mapProduct = (p: any) => {
    try {
      ...
      return {
        ...
        oldPrice,
        discount,
        rating: p.approved_reviews_avg_rating != null ? parseFloat(p.approved_reviews_avg_rating) : 0,
        reviews: p.approved_reviews_count != null ? Number(p.approved_reviews_count) : 0,
        soldPercent,
        leftCount,
        image,
        description:
