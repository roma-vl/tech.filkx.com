    ...
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div v-if="loading" class="space-y-6">
        <nav class="flex items-center gap-2 text-xs text-gray-400">
          ...
          <span>/</span>
          <div
            class="h-4 w-16 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse"
          />
        </nav>
        <div
          class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 md:p-10 space-y-6"
        >
          <div
            class="h-10 bg-zinc-200 dark:bg-zinc-800 rounded-2xl w-2/3 animate-pulse"
          />
      ...
      <div v-else class="space-y-4">
        ...
        >
          ...
          <span>/</span>
          <span
            class="text-gray-700 dark:text-gray-200 font-semibold truncate max-w-xs"
          >
        ...
        <!-- Main Card Container -->
        <article
          class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 md:p-10 shadow-sm relative overflow-hidden"
        >
          ...
          <header class="mb-6">
            <h1
              class="text-2xl md:text-3.5xl font-black text-zinc-900 dark:text-white tracking-tight leading-tight"
            >
              {{ page.title?.[locale] || page.title?.uk || page.title?.en }}
            </h1>
          ...
          <div
            ...
            v-html="
              page.content?.[locale] || page.content?.uk || page.content?.en
            "
          />
        </article>
      </div>
...
.page-content h1 {
  @apply text-2xl md:text-3xl font-black mt-8 mb-4 text-zinc-900 dark:text-white;
}
.page-content h2 {
  @apply text-xl md:text-2xl font-bold mt-7 mb-3 pb-2 border-b border-zinc-100 dark:border-zinc-800 text-zinc-900 dark:text-white;
}
.page-content h3 {
  @apply text-lg md:text-xl font-bold mt-6 mb-2 text-zinc-900 dark:text-white;
}
.page-content h4 {
  @apply text-base font-bold mt-4 mb-2 text-zinc-900 dark:text-white;
}
.page-content p {
  @apply mb-5 leading-relaxed text-sm md:text-base;
}
.page-content ul {
  @apply list-disc pl-6 mb-5 space-y-2 text-sm md:text-base;
}
.page-content ol {
  @apply list-decimal pl-6 mb-5 space-y-2 text-sm md:text-base;
}
...
.page-content img {
  @apply rounded-2xl max-w-full my-6 mx-auto shadow-sm;
}
.page-content a {
...
.page-content th {
  @apply bg-zinc-50 dark:bg-zinc-800/50 px-4 py-2.5 text-left text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400;
}
.page-content td {
  @apply border border-zinc-100 dark:border-zinc-800 px-4 py-2.5;
}
mark {
  @apply bg-yellow-100 dark:bg-yellow-900/40 rounded px-0.5;
}
</style>
