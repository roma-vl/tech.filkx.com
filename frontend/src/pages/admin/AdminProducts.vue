<template>
  <div class="space-y-6">
    <!-- Tabs Header -->
    <div
      class="flex flex-wrap gap-2 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800"
    >
      <button
        v-for="tab in tabs"
        :key="tab.id"
