...
const columns = computed(() => [
  ...
  {
    key: "user.name",
    label: t("admin.accounting.ledger.columns.user"),
    path: "user.name",
  },
  ...
  {
    key: "referenceType",
    label: t("admin.accounting.ledger.columns.ref_type"),
  },
...
const downloadExport = async () => {
  ...
  try {
    ...
    link.setAttribute(
      "download",
      `ledger_export_${new Date().toISOString()}.csv`,
    );
