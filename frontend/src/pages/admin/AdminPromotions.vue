<template>
  <div class="space-y-6 animate-in fade-in duration-500">
    ...
    >
      ...
      <div class="flex items-center gap-3 flex-1 max-w-md">
        ...
        <AppButton
          ...
          :title="t('admin.marketing.promotions.filterPanel.toggle')"
      ...
      >
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <AppSelect
            ...
            :label="t('admin.marketing.promotions.filterPanel.statusLabel')"
            :placeholder="t('admin.marketing.promotions.filterPanel.statusAll')"
            :options="[
              {
                id: '',
                name: t('admin.marketing.promotions.filterPanel.statusAll'),
              },
              {
                id: 'active',
                name: t('admin.marketing.promotions.filterPanel.statusActive'),
              },
              {
                id: 'inactive',
                name: t(
                  'admin.marketing.promotions.filterPanel.statusInactive',
                ),
              },
            ]"
            option-value="id"
        ...
        >
          <AppButton
            ...
            @click="resetFilters"
          >
            {{ t("admin.marketing.promotions.filterPanel.reset") }}
          </AppButton>
        </div>
      </div>
    </transition>
    ...
    <AppConfirmModal
      ...
      :confirm-text="t('admin.marketing.promotions.alerts.confirmButton')"
      :cancel-text="t('admin.marketing.promotions.cancel')"
...
const handleDeleteConfirm = async () => {
  ...
  try {
    await api.delete(
      `/admin/marketing/promotions/${promotionToDelete.value.id}`,
    );
