...
<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex">
    ...
    >
      ...
      <div class="absolute inset-0 bg-gradient-to-br from-primary-600/30 via-violet-600/20 to-indigo-700/30" />
      <div class="absolute top-1/4 left-1/4 w-64 h-64 bg-primary-500/20 rounded-full blur-3xl" />
      <div class="absolute bottom-1/4 right-1/4 w-48 h-48 bg-violet-500/20 rounded-full blur-3xl" />

      <div class="relative z-10 w-full max-w-sm">
        <!-- Brand -->
        <a href="/" class="inline-flex items-center gap-3 mb-12 group">
          <div class="w-10 h-10 rounded-xl bg-primary-500 flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
        ...
        <div class="mt-12 space-y-4">
          ...
          <div class="flex items-center gap-3 text-slate-300">
            ...
            <span class="text-sm">Fast worldwide shipping</span>
          </div>
          <div class="flex items-center gap-3 text-slate-300">
            <div class="w-8 h-8 rounded-full bg-primary-500/20 flex items-center justify-center shrink-0">
              <svg class="w-4 h-4 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex-1 flex flex-col items-center justify-center p-6 sm:p-10">
      ...
      <a href="/" class="flex items-center gap-2 mb-8 lg:hidden group">
        ...
        <span class="text-xl font-bold text-white">Tech Filkx</span>
      </a>
