...
const bgColorMap: Record<string, string> = {
  ...
  purple: "bg-purple-50/50 dark:bg-purple-900/10 border-purple-200/50 dark:border-purple-700/50 text-purple-700 dark:text-purple-300 shadow-sm",
  orange: "bg-orange-50/50 dark:bg-orange-900/10 border-orange-200/50 dark:border-orange-700/50 text-orange-700 dark:text-orange-300 shadow-sm",
  red: "bg-red-50/50 dark:bg-red-900/10 border-red-200/50 dark:border-red-700/50 text-red-700 dark:text-red-300 shadow-sm",
};

const bgColorClass = computed(() => bgColorMap[props.color ?? "gray"] ?? bgColorMap.gray);
</script>
