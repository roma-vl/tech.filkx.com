...
<template>
  <div class="space-y-6 animate-fade font-sans">
      ...
      >
        ...
        <div class="min-w-0 flex-1">
          <div
            ...
            class="h-5 w-10 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse mb-0.5"
          />
          <p
            v-else
          ...
          <p
            class="text-xs text-zinc-400 dark:text-zinc-500 mt-0.5 font-medium truncate"
          >
            {{ stat.label }}
          </p>
        </div>
        <span
          class="material-symbols-outlined text-[15px] text-zinc-300 dark:text-zinc-700 group-hover:text-zinc-400 dark:group-hover:text-zinc-500 transition-colors shrink-0"
          >chevron_right</span
        >
      </button>
    </div>
    ...
    <!-- Quick actions -->
    <div
      class="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-xl p-5"
    >
      <h3
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        >
          ...
          <span
            class="text-xs font-bold text-zinc-600 dark:text-zinc-400 leading-tight text-center"
            >{{ action.label }}</span
          >
        </button>
      </div>
