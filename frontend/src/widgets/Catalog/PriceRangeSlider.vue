  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center gap-2">
      <div class="flex-1 relative">
        <span
          class="absolute left-2.5 top-1/2 -translate-y-1/2 text-[10px] text-zinc-455 dark:text-zinc-550 font-extrabold"
          >₴</span
        >
        <input
          v-model.number="localMin"
      ...
      <span class="text-zinc-450 dark:text-zinc-500 text-[10px] font-black"
        >—</span
      >
      <div class="flex-1 relative">
        <span
