<template>
  ...
  >
        ...
        <a
          :class="
            !selectedCategory
              ...
              : 'text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 font-semibold'
          "
    ...
    <div class="p-5 space-y-3">
      <h3
        class="font-extrabold text-[10px] uppercase tracking-widest text-zinc-400 dark:text-zinc-500 mb-1"
      >
    ...
    <div class="p-5">
      <h3
        class="font-extrabold text-[10px] uppercase tracking-widest text-zinc-400 dark:text-zinc-500 mb-4"
      >
        Ціновий діапазон
      </h3>
      <PriceRangeSlider
    ...
    <div class="p-5">
      <div class="flex items-center justify-between mb-3.5">
        <h3
          class="font-extrabold text-[10px] uppercase tracking-widest text-zinc-400 dark:text-zinc-500"
        >
          Бренд
        </h3>
        <button
