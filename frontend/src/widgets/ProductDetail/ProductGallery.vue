<template>
  <div class="flex flex-col-reverse md:flex-row gap-4">
    <!-- Thumbnails -->
    <div
      class="flex md:flex-col gap-2 overflow-x-auto md:overflow-x-visible shrink-0 pb-1 md:pb-0"
    >
      <button
    ...
    >
      ...
      <!-- Prev/Next arrows -->
      <div
        class="absolute inset-x-3 top-1/2 -translate-y-1/2 flex justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none"
      >
        <button
      ...
      <!-- Image counter -->
      <div
        class="absolute bottom-3 left-3 text-[10px] font-semibold text-zinc-400 dark:text-zinc-500 opacity-0 group-hover:opacity-100 transition-opacity"
      >
